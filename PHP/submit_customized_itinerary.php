...
// Insert data into the customized_itineraries table
$sql = "INSERT INTO create_travel (client_name, destination, start_date, end_date, lodging, duration, formatted_duration) 
...
if ($conn->query($sql) === TRUE) {
    ...
    if (isset($_POST['day_number']) && isset($_POST['date']) && isset($_POST['day']) && isset($_POST['start_time']) && isset($_POST['end_time']) && isset($_POST['activity'])) {
        ...
        // Insert each day's activity into the customized_itinerary_days table
        for ($i = 0; $i < count($day_numbers); $i++) {
            ...
            $sql_day = "INSERT INTO customized_itinerary_days (itinerary_id, day_number, date, day, start_time, end_time, activity) 
